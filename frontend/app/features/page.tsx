...
export default function Features() {
  return (
    <div className="flex flex-col items-center justify-center w-screen min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex flex-col items-center justify-center w-full max-w-screen-md px-8 mx-auto text-center mt-16">
        <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-200">Features</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          {/* Feature Card 1 */}
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-200">
            <div className="flex items-center justify-center mb-4">
              <div className="w-12 h-12 rounded-full bg-blue-500 flex items-center justify-center text-white text-2xl">
                🌐
              </div>
            </div>
            <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-100">Real-Time Collaboration</h2>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-200">
            ...
            <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-100">AI-Powered Suggestions</h2>
            <p className="text-gray-500 mt-2 dark:text-gray-300">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-200">
            ...
            <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-100">Customizable Environment</h2>
            <p className="text-gray-500 mt-2 dark:text-gray-300">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-200">
            ...
            <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-100">Integrated Version Control</h2>
            <p className="text-gray-500 mt-2 dark:text-gray-300">
